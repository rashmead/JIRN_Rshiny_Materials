function(input, output){
        ...
        isolate({
            ...
            if(input$selected_grouping != "no_grouping"){
                p = ggplot(tab_data()) + 
                    ...
                    ggtitle(plot_title()) +
                    xlab(names(outcome_variables)[outcome_variables == input$selected_outcome]) +
                    labs(fill = names(grouping_variables)[grouping_variables == input$selected_grouping]) +
    ...
    output$output_table = renderTable({
        ...
        isolate({
            ...
            names(table_data) = tab_data_names
